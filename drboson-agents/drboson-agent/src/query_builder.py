# Source: https://github.com/anubhavj99/rdflib/blob/cfee37467468ddbaafa870d2eca8b5fa2b32fffc/rdflib/query_builder.py
# Modified to support OPTIONAL blocks
...
class OPTIONAL_BLOCK(STATEMENT):
    def __new__(cls, *args):
        ...
        return tuple.__new__(OPTIONAL_BLOCK, statements)

    def n3(self):
        n3_string = "OPTIONAL { \n"
        n3_string += "".join(map(lambda s: s.n3() + "\n", self))
        n3_string += "} ."
